...
const About = () => {
  ...
  <section id="about" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6 text-professional-navy dark:text-white">About Me</h2>
  ...
  <Card className="p-8 border-0 shadow-lg bg-card">
          <h3 className="text-2xl font-bold mb-6 text-professional-navy dark:text-white text-center">Technical Skills</h3>
          <div className="flex flex-wrap gap-3 justify-center mb-4">
            {skills.slice(0, 7).map((skill, index) => (
              <Badge
                key={index}
                variant="secondary"
                className="px-4 py-2 text-sm font-medium bg-gradient-to-r from-primary/10 to-accent/10 text-professional-navy dark:text-muted-foreground border-primary/20 hover:bg-gradient-to-r hover:from-primary/20 hover:to-accent/20 transition-all duration-300"
              >
                {skill}
              </Badge>
            ))}
          ...
          {skills.length > 7 && (
            <Accordion type="single" collapsible className="w-full max-w-md mx-auto">
              <AccordionItem value="more-skills">
                <AccordionTrigger className="justify-center text-primary dark:text-white font-semibold text-base">
                  See more
                </AccordionTrigger>
                <AccordionContent>
